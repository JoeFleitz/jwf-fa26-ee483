...
ARG COURSE_PATH="${CATKIN_WS_DIR}/src/${REPO_NAME}/ee483"
...
RUN wget -qO - https://raw.githubusercontent.com/ros/rosdistro/master/ros.key | sudo apt-key add -
